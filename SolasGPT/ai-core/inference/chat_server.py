"""
SolasAI Chat Server - Unified inference API
Loads trained model and serves chat completions over HTTP.
Works with conversation, coding, and minecraft specialized models.

Usage:
  python chat_server.py                  # port 8788 by default
  python chat_server.py --port 8788
  python chat_server.py --port 8788 --mode minecraft
"""
